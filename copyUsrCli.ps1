...
# #Everything to be added down here for the forms

# # where is the XAML file?
# $xamlFile = "\\fscluster\u_aic\ahase\Documents\scripts\copyTemplateUser\frontEnd\UserCopy\UserCopy\MainWindow.xaml"
